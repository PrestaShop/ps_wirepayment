...
class Ps_Wirepayment extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->trans('Accept wire payments by displaying your account details during the checkout and make it easy for your customers to purchase on your store.', [], 'Modules.Wirepayment.Admin');
